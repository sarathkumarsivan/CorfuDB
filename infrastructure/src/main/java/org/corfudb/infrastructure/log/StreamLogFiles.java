...
import static org.corfudb.common.compression.Codec.getCodecTypeById;
...
public class StreamLogFiles implements StreamLog, StreamLogWithRankedAddressSpace {
    ...
    private LogData getLogData(LogEntry entry) {
        ...
        Codec.Type ldCodecType = entry.hasCodecType() ? getCodecTypeById(entry.getCodecType()) : Codec.Type.NONE;
        ...
        logData.setPayloadCodecType(ldCodecType);
